$(document).ready(function() {	
	...
	// On page load > documents
	var xin_table_document_onboarding = $('#xin_table_document_onboarding').dataTable({
        "bDestroy": true,
		"ajax": {
            url : main_url+"files/user_onboarding_documents/0",
            type : 'GET'
        },
		"language": {
			"lengthMenu": dt_lengthMenu,
	...
	// On page load > documents
	var xin_table_document_offboarding = $('#xin_table_document_offboarding').dataTable({
        "bDestroy": true,
		"ajax": {
            url : main_url+"files/user_offboarding_documents/0",
            type : 'GET'
        },
		"language": {
			"lengthMenu": dt_lengthMenu,
	...
	// On page load > documents
	var xin_table_document_resignation = $('#xin_table_document_resignation').dataTable({
        "bDestroy": true,
		"ajax": {
            url : main_url+"files/user_resigntion_documents/0",
            type : 'GET'
        },
		"language": {
			"lengthMenu": dt_lengthMenu,
	...
	$('.view-modal-data').on('show.bs.modal', function (event) {
		...
		if(field_tpe == 'onboarding'){
			var field_add = '&data=user_onboarding&type=user_onboarding&';
		} else if(field_tpe == 'offboarding'){
			var field_add = '&data=user_offboarding&type=user_offboarding&';
		} else if(field_tpe == 'resignation'){
			var field_add = '&data=user_resignation&type=user_resignation&';
		}
		var modal = $(this);
		$.ajax({
			url: main_url+'files/read_user_signature_document',
			type: "GET",
