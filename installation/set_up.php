...
if(!empty($_POST) && $_POST['is_ajax']=='1' && $_POST['type']=='set_up'){
	...
	$user_sql = "UPDATE ci_erp_users SET company_name='$company_name',first_name='$first_name',last_name='$last_name',email='$email',username='$username',password='$password_hash' WHERE user_id=1";
	//$conn->query($user_sql);

	if ($conn->query($user_sql) === TRUE) {
		
		$_SESSION['admin_username'] = $username;
	  	$Return['result'] = "You have successfully installed the TimeHRM - The Cloud HRM.";
	} else {
