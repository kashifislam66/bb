...
$(document).ready(function(){
	...
	$('#calendar_hr').fullCalendar({
        ...
        date_last_clicked = $(this);
			...
			//alert(event_date);
			$.ajax({
				url : main_url+"events/add_new_event_record",
				type: "GET",
				data: 'jd=1&is_ajax=1&mode=modal&type=new_event_record&event_date='+event_date+"&record="+this_record,
				success: function (response) {
					if(response) {
		...
		events: [
			...
			<?php if($events['is_show_calendar']==1):?>
			{
