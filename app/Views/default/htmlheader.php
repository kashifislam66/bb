...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url();?>/public/assets/css/layout-creative.css">
   ...
   <!-- rangeslider css -->
    ...
    <?php } ?>
    <?php if($router->methodName() !='shift_calendar'){?>
    ...
    <link rel="stylesheet" href="<?= base_url();?>/public/assets/css/chat_box.css">
    <?php } ?>
    <link rel="stylesheet" href="<?= base_url();?>/public/assets/css/plugins/bootstrap-timepicker.min.css">
