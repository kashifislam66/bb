...
<ul class="pc-navbar">
  ...
  <!-- Dashboard|Home -->
  <li class="pc-item"><a href="<?= site_url('erp/desk');?>" class="pc-link "><span class="pc-micon pc-mtext"><i data-feather="home"></i></span><span class="pc-mtext">
    <?= lang('Dashboard.dashboard_title');?>
    </span></a></li>
  <!-- Employees -->
  <li class="pc-item"><a href="<?= site_url('erp/staff-list');?>" class="pc-link "><span class="pc-micon pc-mtext"><i data-feather="users"></i></span><span class="pc-mtext">
    <?= lang('Dashboard.dashboard_employees');?>
    </span></a></li>
    <?php if(isset($setup_modules['recruitment'])): if($setup_modules['recruitment']==1):?>
  <!-- Recruitment -->
  <li class="pc-item"> <a href="<?= site_url('erp/jobs-list');?>" class="pc-link"> <span class="pc-micon pc-mtext"><i data-feather="gitlab"></i></span><span class="pc-mtext">
    <?= lang('Recruitment.xin_recruitment_ats');?>
    </span> </a> </li>
    <?php endif; endif;?>
  <!-- CoreHR -->
  <li class="pc-item <?php if(!empty($arr_mod['corehr_open']))echo $arr_mod['corehr_open'];?>"> <a href="#" class="pc-link sidenav-toggle"> <span class="pc-micon pc-mtext"><i data-feather="crosshair"></i></span>
  ...
  <!-- Attendance -->
  <li class="pc-item pc-hasmenu <?php if(!empty($arr_mod['attendance_open']))echo $arr_mod['attendance_open'];?>"> <a href="#" class="pc-link sidenav-toggle"><span class="pc-micon pc-mtext"><i data-feather="clock"></i></span><span class="pc-mtext">
  ...
  <!-- Finance -->
  <li class="pc-item"> <a href="<?= site_url('erp/accounts-list');?>" class="pc-link"> <span class="pc-micon pc-mtext"><i data-feather="credit-card"></i></span><span class="pc-mtext">
    <?= lang('Dashboard.xin_hr_finance');?>
    </span> </a> </li>
  <?php endif; endif;?>  
  <?php if(isset($setup_modules['payroll'])): if($setup_modules['payroll']==1):?>
  <!-- Payroll -->
  <li class="pc-item"> <a href="<?= site_url('erp/payroll-list');?>" class="pc-link"> <span class="pc-micon pc-mtext"><i data-feather="speaker"></i></span><span class="pc-mtext">
    <?= lang('Dashboard.left_payroll');?>
    </span> </a> </li>
  <?php endif; endif;?>
  <?php if(isset($setup_modules['performance'])): if($setup_modules['performance']==1):?>
  <!-- Performance -->
  <li class="<?php if(!empty($arr_mod['talent_open']))echo $arr_mod['talent_open'];?> pc-item"> <a href="#" class="pc-link sidenav-toggle"> <span class="pc-micon pc-mtext"><i data-feather="aperture"></i></span>
  ...
  <li class="pc-item pc-hasmenu">
        <a href="#!" class="pc-link"><span class="pc-micon pc-mtext"><i data-feather="menu"></i></span><span class="pc-mtext"><?= lang('Inventory.xin_inventory_control');?></span><span class="pc-arrow"><i data-feather="chevron-right"></i></span></a>
        <ul class="pc-submenu">
  ...
  <?php endif; endif;?>
  <!-- Tasks -->
  <li class="pc-item"> <a href="<?= site_url('erp/tasks-grid');?>" class="pc-link"><span class="pc-micon pc-mtext"><i data-feather="edit"></i></span><span class="pc-mtext">
    <?= lang('Dashboard.left_tasks');?>
    </span> </a> </li>
  <!-- Projects -->
  <li class="pc-item"> <a href="<?= site_url('erp/projects-grid');?>" class="pc-link"><span class="pc-micon pc-mtext"><i data-feather="layers"></i></span><span class="pc-mtext">
    <?= lang('Dashboard.left_projects');?>
    </span> </a> </li>
  <!-- Clients -->
  <li class="pc-item"><a href="<?= site_url('erp/clients-list');?>" class="pc-link "><span class="pc-micon pc-mtext"><i data-feather="user-check"></i></span><span class="pc-mtext">
    <?= lang('Projects.xin_manage_clients');?>
    </span></a></li>
  <!-- Leads -->
  <li class="pc-item"><a href="<?= site_url('erp/leads-list');?>" class="pc-link "><span class="pc-micon pc-mtext"><i data-feather="user-plus"></i></span><span class="pc-mtext">
    <?= lang('Dashboard.xin_leads');?>
    </span></a></li>  
  <!-- Tickets -->
  <li class="pc-item"> <a href="<?= site_url('erp/support-tickets');?>" class="pc-link"> <span class="pc-micon pc-mtext"><i data-feather="help-circle"></i></span><span class="pc-mtext">
    <?= lang('Dashboard.dashboard_helpdesk');?>
    </span> </a> </li>
  <!-- Invoices -->
  <li class="pc-item"><a href="<?= site_url('erp/invoices-list');?>" class="pc-link "><span class="pc-micon pc-mtext"><i data-feather="calendar"></i></span><span class="pc-mtext">
    <?= lang('Dashboard.xin_invoices_title');?>
    </span></a></li>
 <!-- Estimates -->
  <li class="pc-item"><a href="<?= site_url('erp/estimates-list');?>" class="pc-link "><span class="pc-micon pc-mtext"><i data-feather="calendar"></i></span><span class="pc-mtext">
    <?= lang('Dashboard.xin_estimates');?>
    </span></a></li>   
  <!-- Leave -->
  <li class="pc-item"> <a href="<?= site_url('erp/leave-list');?>" class="pc-link"> <span class="pc-micon pc-mtext"><i data-feather="plus-square"></i></span><span class="pc-mtext">
    <?= lang('Leave.left_leave_request');?>
    </span> </a> </li>
  <?php if(isset($setup_modules['training'])): if($setup_modules['training']==1):?>
  <!-- Training Session -->
  <li class="pc-item"> <a href="<?= site_url('erp/training-sessions');?>" class="pc-link"> <span class="pc-micon pc-mtext"><i data-feather="target"></i></span><span class="pc-mtext">
    <?= lang('Dashboard.left_training');?>
    </span> </a> </li>
  <?php endif; endif;?>
  <!-- Disciplinary -->
  <li class="pc-item"> <a href="<?= site_url('erp/disciplinary-cases');?>" class="pc-link"> <span class="pc-micon pc-mtext"><i data-feather="alert-circle"></i></span><span class="pc-mtext">
