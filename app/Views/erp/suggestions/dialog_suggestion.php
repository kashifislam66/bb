...
$get_animate = '';
if($request->getGet('data') === 'suggestion' && $request->getGet('field_id')){
$ifield_id = udecode($field_id);
$result = $SuggestionsModel->where('suggestion_id', $ifield_id)->first();
...
<?php $attributes = array('name' => 'edit_suggestion', 'id' => 'edit_suggestion', 'autocomplete' => 'off', 'class'=>'m-b-1');?>
<?php $hidden = array('_method' => 'EDIT', 'token' => $field_id);?>
<?php echo form_open_multipart('erp/suggestions/update_suggestion', $attributes, $hidden);?>
  ...
  <div class="row m-b-1">
    ...
    <div class="col-md-4">
      ...
      <fieldset class="form-group">
        ...
        <?php
			  $imageProperties = [
				'src'    => base_url().'/public/uploads/suggestions/'.$result['attachment'],
				'alt'    => $result['title'],
...
<script type="text/javascript">
 $(document).ready(function(){
		...
		/* Edit data */
		$("#edit_suggestion").submit(function(e){
			...
			success: function(JSON)
			{
				if (JSON.error != '') {
					...
					var xin_table = $('#xin_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("erp/suggestions/suggestions_list") ?>",
								type : 'GET'
							},
							"language": {
