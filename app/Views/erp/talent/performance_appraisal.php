              ...
              <table class="table table-borderless">
                ...
                <tbody>
                  ...
                  <tr class="m-b-1">
                    ...
                    <td align="right"><select class="bar-rating" name="technical_competencies_value[<?php echo $itech_comp['constants_id'];?>]" autocomplete="off">
                  ...
                  <tr class="m-b-1">
                    <td scope="row" colspan="3"><strong><?= lang('Main.xin_kpa_comments');?>: </strong> <?php echo $itech_comp['field_one'];?></td>
                  </tr>
                  <tr class="m-b-1">
                    <td scope="row" colspan="3"><strong><?= lang('Projects.xin_description');?>: </strong> <?php echo $itech_comp['field_two'];?></td>
                  </tr>
                  <?php endforeach;?>
                </tbody>
              </table>
              ...
              <table class="table table-borderless">
                ...
                <tbody>
                  ...
                  <tr class="m-b-2">
                    ...
                    <td align="right"><select name="organizational_competencies_value[<?php echo $iorg_comp['constants_id'];?>]" class="bar-rating" autocomplete="off">
                        <option value="1">1</option>
                        <option value="2">2</option>
                        <option value="3">3</option>
                        <option value="4">4</option>
                  ...
                  <tr class="m-b-1">
                    <td scope="row" colspan="3"><strong><?= lang('Main.xin_kpa_comments');?>: </strong> <?php echo $iorg_comp['field_one'];?></td>
                  </tr>
                  <tr class="m-b-1">
                    <td scope="row" colspan="3"><strong><?= lang('Projects.xin_description');?>: </strong> <?php echo $iorg_comp['field_two'];?></td>
                  </tr>
                  <?php endforeach;?>
                </tbody>
              </table>
