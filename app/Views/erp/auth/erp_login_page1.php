      ...
      <div class="row align-items-stretch text-center">
        ...
        <div class="col-md-6">
          <div class="card-body">
            ...
            <div class="mt-2 success-msg" style="display:none;">
              <div class="alert alert-success mt-2" role="alert">
                <strong id="msg_one">&nbsp;</strong>
            </div>
            </div>
            <div class="text-right mt-2 has-help">
              <button type="submit" class="btn btn-primary mt-2"><i class="fas fa-user-lock d-blockd"></i>
              <?= lang('Login.xin_login');?>
              </button>
            </div>
            <?= form_close(); ?>
            <p class="mb-0 text-left text-muted"><?= lang('Main.xin_dont_hv_an_account');?> <a href="<?= site_url('register');?>" class="f-w-400"><?= lang('Main.xin_signup');?></a></p>
          </div>
        </div>
      </div>
    </div>
