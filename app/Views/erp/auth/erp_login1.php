            ...
            <div class="">
              ...
              <div class="form-group text-left my-2">
                ...
                <div class="d-inline-block">
                    <strong class="text-success">Login With</strong>
                    </div>
              </div>
            </div>
            <div class="d-inline-block">
                <div class="btn-group btn-group-sm" role="group" aria-label="button groups sm">
                    <button type="button" class="btn login-as btn-outline-primary" data-demo_user="super.admin" data-demo_password="super.admin">Super Admin</button>
                    <button type="button" class="btn login-as btn-outline-primary" data-demo_user="timehrm" data-demo_password="timehrm">Company</button>
                    <button type="button" class="btn login-as btn-outline-primary" data-demo_user="joe.larson" data-demo_password="joe.larson">Employee</button>
                    <button type="button" class="btn login-as btn-outline-primary" data-demo_user="cedric.kelly" data-demo_password="cedric.kelly">Client</button>
                    </div>
                </div>
