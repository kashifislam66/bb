...
<div class="row"> 
  ...
  <div class="col-lg-4">
    <div class="card user-card user-card-1">
      ...
      <div class="nav flex-column nav-pills list-group list-group-flush list-pills" id="user-set-tab" role="tablist" aria-orientation="vertical"> <a class="nav-link list-group-item list-group-item-action active" id="user-set-salary-tab" data-toggle="pill" href="#user-set-salary" role="tab" aria-controls="user-set-salary" aria-selected="false"> <span class="f-w-500"><i class="feather icon-lock m-r-10 h5 "></i>
        ...
        <a class="nav-link list-group-item list-group-item-action" id="user-set-onboarding-document-tab" data-toggle="pill" href="#user-set-onboarding-document" role="tab" aria-controls="user-set-onboarding-document" aria-selected="false"> <span class="f-w-500"><i class="feather icon-file-text m-r-10 h5 "></i>
  ...
  <div class="col-lg-8">
    <div class="tab-content" id="user-set-tabContent">
      ...
      <?php } ?>
      <div class="tab-pane fade" id="user-set-onboarding-document" role="tabpanel" aria-labelledby="user-set-onboarding-document-tab">
        <div class="card">
          <div class="card-header">
            <h5><i data-feather="file-plus" class="icon-svg-primary wid-20"></i><span class="p-l-5">
              <?= lang('Main.xin_e_signature_files');?>
          ...
          <div class="col-sm-12">
				<div class="accordion" id="accordionExample">
					<div class="card user-profile-list" style="border: 1px solid #ccc; margin-bottom: 15px;">
						<div class="card-header" id="headingOne">
							<h5 class="mb-0"><a href="#!" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne" class="collapsed"><?= lang('Main.xin_onboarding_files');?></a></h5>
						</div>
						<div id="collapseOne" class="card-body collapse" aria-labelledby="headingOne" data-parent="#accordionExample" style="">
							<div class="box-datatable table-responsive mb-5">
                              <table class="table table-striped table-bordered dataTable" id="xin_table_document_onboarding" style="width:100%;">
                                <thead>
                                  <tr>
                                    <th><?= lang('Employees.xin_document_name');?></th>
                                    <th><?= lang('Main.xin_signed');?></th>
					...
					<div class="card user-profile-list" style="border: 1px solid #ccc; margin-bottom: 15px;">
						<div class="card-header" id="headingTwo">
							<h5 class="mb-0"><a href="#!" class="collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"><?= lang('Main.xin_offboarding_files');?></a></h5>
						</div>
						<div id="collapseTwo" class="collapse card-body" aria-labelledby="headingTwo" data-parent="#accordionExample">
							<div class="box-datatable table-responsive">
                              <table class="table table-striped table-bordered dataTable" id="xin_table_document_offboarding" style="width:100%;">
                                <thead>
                                  <tr>
                                    <th><?= lang('Employees.xin_document_name');?></th>
                                    <th><?= lang('Main.xin_signed');?></th>
                    ...
                    <div class="card user-profile-list" style="border: 1px solid #ccc; margin-bottom: 15px;">
						<div class="card-header" id="headingThree">
							<h5 class="mb-0"><a href="#!" class="collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree"><?= lang('Main.xin_resignation_file');?></a></h5>
						</div>
						<div id="collapseThree" class="collapse card-body" aria-labelledby="headingThree" data-parent="#accordionExample">
							<div class="box-datatable table-responsive">
                              <table class="table table-striped table-bordered dataTable" id="xin_table_document_resignation" style="width:100%;">
                                <thead>
                                  <tr>
                                    <th><?= lang('Employees.xin_notice_date');?></th>
                                    <th><?= lang('Main.xin_signature_file');?></th>
                                    <th width="100"><?= lang('Main.xin_created_at');?></th>
                                  </tr>
                                </thead>
                              </table>
