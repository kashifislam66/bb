                  ...
                  <table class="table m-b-0 f-14 b-solid requid-table">
                    <thead>
                      <tr class="text-uppercase">
                        <th colspan="6"><?php echo lang('Attendance.xin_attendance_information');?></th>
                      </tr>
                    </thead>
                    <tbody class="text-muted">
                      <tr>
                        ...
                        <th><?= lang('Main.xin_lunch_out');?></th>
                        <th><?= lang('Main.xin_back_from_lunch');?></th>
                        <th><?= lang('Main.xin_total_lunch_time');?></th>
                      </tr>
                      <?php $hrs_old_int1 = 0; ?>
                      ...
                      <?php
						...
						// print_r($clock_out_time); echo "sdfds";
						...
						$str_time =$timee;
						if($r['lunch_breakin'] == 0){
							$ilunchbreak_in_time = '00:00';
						} else {
							// lunch break in time
							$lunchbreak_in_time = strtotime($r['lunch_breakin']);
							$ilunchbreak_in_time = date("h:i a", $lunchbreak_in_time);
						}
						if($r['lunch_breakout'] == 0){
							$ilunchbreak_out_time = '00:00';
						} else {
							// lunch break out time
							$lunchbreak_out_time = strtotime($r['lunch_breakout']);
							$ilunchbreak_out_time = date("h:i a", $lunchbreak_out_time);
						}
						if($r['lunch_breakin'] == 0 || $r['lunch_breakout'] == 0){
							$total_lunch_time = '00:00';
						} else {
							//time_diff
							$time1 = new DateTime($r['lunch_breakin']);
							$time2 = new DateTime($r['lunch_breakout']);
							$time_diff = $time1->diff($time2);
							$total_lunch_time = $time_diff->h.':'.$time_diff->i;
						}
                        ...
                        ?>
                      <tr>
                        <td width="200"><?= $fclock_in;?></td>
                        <td width="200"><?= $fclock_out;?></td>
                        <td width="200"><?= $r['total_work'];?></td>
                        <td width="200"><?= $ilunchbreak_in_time;?></td>
                        <td width="200"><?= $ilunchbreak_out_time;?></td>
                        <td width="200"><?= $total_lunch_time;?></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
