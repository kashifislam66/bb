        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <div class="input-group">
              <input class="form-control event_time_dropdown" placeholder="<?= lang('Conference.xin_hr_event_time');?>" name="event_time" type="text">
            </div>
            </div>
          </div>
        </div>
            ...
            <div class="form-group">
              <label><?= lang('Main.xin_event_in_calendar');?></label>
                <div class="custom-control custom-switch">
                    <input type="checkbox" name="is_show_calendar" class="custom-control-input input-light-primary" id="customevent1" value="1" checked>
                    <label class="custom-control-label" for="customevent1"><?= lang('Main.xin_event_in_calendar_info');?></label>
                </div>
