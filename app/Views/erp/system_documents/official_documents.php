...
<div id="smartwizard-2" class="border-bottom smartwizard-example sw-main sw-theme-default mt-2">
  <ul class="nav nav-tabs step-anchor">
   ...
   <?php } ?>
   <li class="nav-item clickable"> <a href="<?= site_url('erp/signature-files');?>" class="mb-3 nav-link"> <span class="sw-done-icon feather icon-check-circle"></span> <span class="sw-icon fas fa-file-pdf"></span>
          ...
          <div class="card-body">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label for="license_name"><?= lang('Main.xin_employee_name');?> <span class="text-danger">*</span></label>
                <input class="form-control" placeholder="<?= lang('Main..xin_employee_name');?>" name="license_name" type="text">
              </div>
            </div> 
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="col-md-6">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="license_number"><?= lang('Main.xin_document_number');?> <span class="text-danger">*</span></label>
                    <input class="form-control" placeholder="<?= lang('Main.xin_document_number');?>" name="license_number" type="text">
                  </div>
                </div>
              </div>
          </div>
      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table_document">
        <thead>
          <tr>
            ...
            <th><?= lang('Main.xin_employee_name');?></th>
            <th><?= lang('Main.xin_document_number');?></th>
