    ...
    <div class="col-sm-4">
      <div class="form-group">
        <label for="date_of_expiry" class="control-label">
          <?= lang('Main.xin_employee_name');?>
          <span class="text-danger">*</span></label>
        <input class="form-control" placeholder="<?= lang('Main.xin_employee_name');?>" name="license_name" type="text" value="<?= $result['license_name'];?>">
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
    ...
    <div class="col-md-4">
      <div class="form-group">
        <label for="license_number">
          <?= lang('Main.xin_document_number');?> <span class="text-danger">*</span>
        </label>
        <input class="form-control" placeholder="<?= lang('Main.xin_document_number');?>" name="license_number" type="text" value="<?= $result['license_no'];?>">
      </div>
    </div>
    <div class="col-sm-4">
      <div class="form-group">
