  ...
  <?php if(in_array('helpdesk1',staff_role_resource()) && in_array('helpdesk2',staff_role_resource()) || $user_info['user_type'] == 'company') {?>
    ...
    <?php
		...
		if($created_by){
			...
			$cprofile_pic = staff_profile_photo($r['created_by']);
		} else {
			$icreated_by = '--';
			$cprofile_pic = '--';
		}
		...
		if($iuser){
			...
			$eprofile_pic = staff_profile_photo($r['employee_id']);
		} else {
			$employee_name = '--';
			$eprofile_pic = '--';
		}
    ...
    <div class="ticket-block">
      <div class="row">
        <div class="col-auto sdsadsa"> <img class="media-object wid-60 img-radius" src="<?= $cprofile_pic;?>" alt=""> </div>
        <div class="col">
              ...
              <div class="col border-right pr-0">
                <div class="card-body inner-center">
                  ...
                  <ul class="list-inline mt-2 mb-0">
                    ...
                    <li class="list-inline-item"><img src="<?= $cprofile_pic;?>" alt="" class="wid-20 rounded mr-1 img-fluid">
