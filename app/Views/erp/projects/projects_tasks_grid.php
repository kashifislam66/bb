...
if($user_info['user_type'] == 'staff'){
	...
	$get_tasks = $TasksModel->where('company_id',$user_info['company_id'])->where('task_type','project')->where("assigned_to like '%$id,%' or assigned_to like '%,$id%' or assigned_to = '$id'")->paginate(9);
	$total_tasks = $TasksModel->where('company_id',$user_info['company_id'])->where('task_type','project')->orderBy('task_id', 'ASC')->countAllResults();
	...
	$get_tasks = $TasksModel->where('company_id',$usession['sup_user_id'])->where('task_type','project')->orderBy('task_id', 'ASC')->paginate(9);
	$total_tasks = $TasksModel->where('company_id',$usession['sup_user_id'])->where('task_type','project')->orderBy('task_id', 'ASC')->countAllResults();
        ...
        <div id="accordion">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <input type="hidden" value="project" name="task_type" />
              <div class="col-md-3">
                <div class="form-group">
