  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="form-group">
        ...
        <?php
         $clock_meeting_time = strtotime($result['meeting_time']);
         $clock_meeting = date("h:i A", $clock_meeting_time);
        ?>
        <div class="input-group">
          <input class="form-control time_dropdown" name="conference_time" type="text" value="<?php echo $clock_meeting; ?>">
        </div>
      </div>
    </div>
    <div class="col-md-4">
