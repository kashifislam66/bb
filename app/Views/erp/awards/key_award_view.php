        ...
        <table class="table">
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right"><?php if($result['award_photo']!='' && $result['award_photo']!='no file') {?>
        ...
        <div class="tab-pane fade show active" id="pills-overview" role="tabpanel" aria-labelledby="pills-overview-tab">
          <div class="card-body">
              ...
              <div class="table-responsive">
                <table class="table table-borderless">
                  <tbody class="text-muted">
                    ...
                    <tr>
                      <td><a target="_blank" href="<?= site_url('erp/goal-details/').uencode($track_goal['tracking_id']);?>">
            ...
            <div class="m-b-30 m-t-15">
              ...
              <hr>
              <?php echo html_entity_decode($result['award_information']);?> </div>
            <div class="m-b-30 m-t-15">
              <h6><?php echo lang('Main.xin_description');?></h6>
              <hr>
              <?php echo html_entity_decode($result['description']);?> </div>
          </div>
        </div>
        <?php if(in_array('award3',staff_role_resource()) || $user_info['user_type'] == 'company') { ?>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  <label for="month_year">
                    <?= lang('Employees.xin_award_month_year');?>
                    <span class="text-danger">*</span> </label>
                  <div class="input-group">
