...
<div id="smartwizard-2" class="border-bottom smartwizard-example sw-main sw-theme-default mt-2">
  <ul class="nav nav-tabs step-anchor">
    <li class="nav-item active"> <a href="<?= site_url('erp/forms-builder');?>" class="mb-3 nav-link"> <span class="sw-done-icon feather icon-check-circle"></span> <span class="sw-icon fab fa-wpforms"></span>
    ...
    <li class="nav-item clickable"> <a href="<?= site_url('erp/send-form-list');?>" class="mb-3 nav-link"> <span class="sw-done-icon feather icon-check-circle"></span> <span class="sw-icon fas fa-user-check"></span>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-7 text-md-end">
                    ...
                    <div class="nav nav-tabs btn-group btn-group-sm d-inline-flex" id="myTab" role="tablist">
                        <a class="btn btn-light-primary active m-r-5" id="grid-tab" data-toggle="tab" href="#grid" role="tab" aria-controls="grid" aria-selected="true"><i class="fas fa-th-large"></i></a>
                        <a class="btn btn-light-primary m-r-5" id="list-tab" data-toggle="tab" href="#list" role="tab" aria-controls="list" aria-selected="false"><i class="fas fa-list-ul"></i></a> <a  href="#!" class="btn waves-effect waves-light btn-primary btn-sm m-0" data-toggle="modal" data-target=".view-modal-data" data-field_id="1"> <i data-feather="plus"></i>
        <?= lang('Main.xin_creat_form_builder');?></a>
                    </div>
                </div>
            </div>
        </div>
