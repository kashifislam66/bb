...
<div id="add_form" class="collapse add-form" data-parent="#accordion" style="">
  ...
  <?php echo form_open('erp/users/add_role', $attributes, $hidden);?>
    <div class="row">
      ...
      <div class="col-xl-4 mt-xl-0 mt-3 users-role-col">
        <div class="card">
          <div class="card-header">
            <h5>
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group mb-md-3 mb-2">
                  <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label mb-0" for="1">
                ...
                <div class="form-group mb-md-3 mb-2">
                  <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label mb-0" for="2">
                ...
                <div class="form-group mb-md-3 mb-2">
                  <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label mb-0" for="4">
                ...
                <div class="form-group mb-md-3 mb-2">
                  <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label mb-0" for="5">
                      <?= lang('Main.xin_super_users');?>
                    </label>
                  </div>
                </div>
                <div class="form-group mb-md-3 mb-2">
                  <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label mb-0" for="3">
              ...
              <div class="col-sm-6">
                <div class="form-group mb-md-3 mb-2">
                  <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label mb-0" for="6">
                ...
                <div class="form-group mb-md-3 mb-2">
                  <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label mb-0" for="7">
                ...
                <div class="form-group mb-md-3 mb-2">
                  <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label mb-0" for="8">
                ...
                <div class="form-group mb-md-3 mb-2">
                  <div class="custom-control custom-switch">
                    ...
                    <label class="custom-control-label mb-0" for="9">
