    ...
    <div class="card mb-2">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="form-group">
              <label for="short_description"><?php echo lang('Recruitment.xin_short_description');?></label>
          ...
          <div class="col-md-12">
            <div class="form-group">
              <label for="long_description"><?php echo lang('Recruitment.xin_long_description');?></label>
              <textarea class="form-control editor" placeholder="<?php echo lang('Recruitment.xin_long_description');?>" name="long_description" cols="30" rows="10" id="editor"></textarea>
            </div>
          </div>
        </div>
      </div>
