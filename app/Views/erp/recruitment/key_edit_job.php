        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea class="form-control editor" placeholder="<?php echo lang('Recruitment.xin_long_description');?>" name="long_description" rows="10" cols="30" id="editor"><?= $get_job['long_description'];?>
</textarea>
            </div>
          </div>
        </div>
