...
<?php echo form_open('erp/leave/update_leave', $attributes, $hidden);?>
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					var xin_table = $('#xin_table').dataTable({
						"bDestroy": true,
						"ajax": {
							url : "<?php echo site_url("erp/leave/leave_list") ?>",
							type : 'GET'
						},
						"language": {
...
<?php } elseif($request->getGet('type') === 'leave_summary' && $field_id){
$staff_id = $request->getGet('staff_id');
$report_user_id =	$request->getGet('staff_id');
...
<?php } elseif($request->getGet('data') === 'leave_summary' && $request->getGet('field_id') === 'type'){
