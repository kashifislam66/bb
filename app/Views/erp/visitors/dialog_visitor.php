  ...
  <div class="row">
    ...
    <div class="col-md-3">
      <div class="form-group">
        ...
        <?php
			$clock_in_time = strtotime($result['check_in']);
			$fclckIn = date("h:i A", $clock_in_time);
			?>
        <div class="input-group">
          <input type="text" class="form-control time_dropdown" placeholder="<?= lang('Employees.xin_shift_in_time');?>" name="check_in" value="<?= $fclckIn ?>">
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="form-group">
        ...
        <?php
			$clock_out_time = strtotime($result['check_out']);
			$fclckOut = date("h:i A", $clock_out_time);
			?>
        <div class="input-group">
          <input type="text" class="form-control time_dropdown" placeholder="<?= lang('Employees.xin_shift_out_time');?>" name="check_out" value="<?= $fclckOut;?>">
        </div>
      </div>
    </div>
    <div class="col-md-3">
