        ...
        <div class="new-task-list">
          ...
          <div class="to-do-list mb-3">
            <div class="d-inline-block">
              <label class="check-task form-check <?= $cls_done;?>">
                <input type="checkbox" class="form-check-input" <?= $chk_checked;?> id="item_<?= $items['todo_item_id'];?>" data-field-id="<?= $items['todo_item_id'];?>">
