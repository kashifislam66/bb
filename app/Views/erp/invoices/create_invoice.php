                ...
                <div class="form-sm-row row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <div class="ci-item-values">
                        <div data-repeater-list="items">
                          <div data-repeater-item="">
                            <div class="form-sm-row row item-row">
                              <div class="form-group mb-1 col-8 col-md-5">
                                <label for="item_name">
                              ...
                              <div class="form-group mb-1 col-4 col-md-2">
                              ...
                              <div class="skin skin-flat form-group mb-1 col col-md-2">
                              ...
                              <div class="form-group mb-1 col col-md-2">
                              ...
                              <div class="form-group col-auto col-md-1 text-xs-center mt-md-2">
                      ...
                      <div class="form-sm-row row mt-3">
                        <div class="col-xl-6 col-lg-8 col-sm-12 ms-auto">
