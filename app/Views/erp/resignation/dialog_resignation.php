...
$istaff = $ResignationsModel->where('resignation_id', $ifield_id)->first();
?>
<div class="modal-header">
  <h5 class="modal-title">
          ...
          <table class="table table-striped table-bordered dataTable" id="xin_table_modal_progress" style="width:100%;">
            ...
            <?php
				if($istaff['is_signed']==1){
					...
					$signed_download_link = '<a href="'.site_url().'download?type=pdf_files/resignation/signed/&filename='.uencode($istaff['signed_file']).'">'.lang('Main.xin_download').'</a>';
