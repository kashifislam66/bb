                ...
                <tr>
                    <td>
                        <div class="d-inline-block align-middle text-center">
                            <img src="<?= base_url();?>/public/assets/images/pages/<?= $subs_plan['plan_icon']?>" alt="contact-img" title="contact-img" class="rounded" height="200">
                        </div>
                        <div class="d-inline-block align-middle m-l-20">
                            <a href="#!" class="text-body" data-toggle="modal" data-target=".view-modal-data" data-field_id="<?= uencode($subs_plan['membership_id']);?>">
                                <h5 class="mb-1"><?= $subs_plan['membership_type']?></h5>
                            </a>
                            <p class="text-muted mb-1"><?= $subs_plan['subscription_id']?></p>
                            <p class="text-muted mb-1"><?= lang('Membership.xin_plan_duration');?>: <?= $company_membership_details['plan_duration'];?></p>
                            <h4><?= number_to_currency($subs_price, $xin_system['default_currency'],null,2);?></h4>
                            <p class="text-muted mb-1"><?= $subs_plan['description']?></p>
                        </div>
                    </td>
                    <td class="text-right">
                        <div class="text-left d-inline-block m-r-20">
