...
<div id="add_form" class="collapse add-form <?php echo $get_animate;?>" data-parent="#accordion" style="">
  <div class="card">
    <div id="accordion">
      ...
      <?php echo form_open('erp/termination/add_termination', $attributes, $hidden);?>
      <div class="card-body">
        <div class="row">
          <?php if($user_info['user_type'] == 'company'){?>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <div class="input-group">
                <input class="form-control date" placeholder="<?= lang('Main.xin_termination_date');?>" name="termination_date" type="text">
                <div class="input-group-append"><span class="input-group-text"><i class="fas fa-calendar-alt"></i></span></div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="form-group">
              <label for="reason"> 
                <?= lang('Main.xin_termination_reason');?> <span class="text-danger">*</span>
              </label>
              <textarea class="form-control textarea" placeholder="<?= lang('Main.xin_termination_reason');?>" name="reason" cols="30" rows="3"></textarea>
            </div>
          </div>
        </div>
      </div>
      ...
      <table class="datatables-demo table table-striped table-bordered" id="xin_table">
        <thead>
          <tr>
            ...
            <th><i class="fa fa-calendar"></i>
              <?= lang('Main.xin_termination_date');?></th>
