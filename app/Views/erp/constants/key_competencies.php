      ...
      <div class="card-body">
        <ul class="nav nav-pills mb-0">
          ...
          <li class="nav-item m-r-5"> <a href="#pills-profile" data-toggle="tab" aria-expanded="true" class="">
            <button type="button" class="btn btn-outline-secondary text-uppercase"><?= lang('Performance.xin_talent_org');?></button>
            </a> </li>
        </ul>
      </div>
    </div>
			  ...
			  <div class="col-md-4">
				<div class="card">
				  ...
				  <div class="card-body">
                    ...
                    <div class="form-group">
					  <label for="name">
						<?= lang('Main.xin_kpa_comments');?>
						<span class="text-danger">*</span> </label>
					  <textarea class="form-control" name="comments" placeholder="<?= lang('Main.xin_add_kpa_comments');?>" rows="4"></textarea>
					</div>
                    <div class="form-group">
					  <label for="name">
						<?= lang('Projects.xin_description');?></label>
					  <textarea  class="form-control" name="description" placeholder="<?= lang('Main.xin_add_kpa_description');?>" rows="5"></textarea>
					</div>
				  </div>
			  ...
			  <div class="col-md-4">
				<div class="card">
				  <div class="card-header with-elements"> <span class="card-header-title mr-2"><strong>
					...
					<?= lang('Performance.xin_talent_org_category');?>
					</span> </div>
				  <div class="card-body">
