             ...
             <div class="row">
                <div class="col-md-12">
                    <div class="alert alert-warning" role="alert">
                        <?= lang('Main.xin_unselect_all_options_announcements');?>
                    </div>
                </div>
              </div>
             ...
             <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-control" id="department_id" multiple="multiple" name="department_id[]" data-plugin="select_hrm" data-placeholder="<?= lang('Dashboard.left_department');?>">
                ...
                <input type="hidden" value="0" name="audience_id[]" />
            <div class="col-md-6">
              <div class="form-group" id="staff_ajax">
                
                <label for="audience" class="control-label">
