...
$country = $CountryModel->where('country_id', $xin_system['country'])->first();
?>
                                  ...
                                  <div class="contact__details">
                                     <ul>
                                        <li>
                                           ...
                                           <p><?= $xin_system['address_1'].', '.$xin_system['address_2'];?></p>
                                           <p><?= $xin_system['city'].', '.$country['country_name'];?></p>
                                        </li>
                                        <li>
                                           <h4><?= lang('Frontend.xin_support_email');?></h4>
                                           <p><?= $xin_system['email'];?></p>
                                        </li>
                                     </ul>
                                  </div>
                               </div>
