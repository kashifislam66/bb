...
class MainModel extends Model {
	...
	// Function to update record in table
	public function update_user_signature_tasks($data2, $id){
		
		$db      = \Config\Database::connect();
		$builder = $db->table('ci_staff_signature_documents');
		$builder->where('signature_file_id', $id);
		$builder->update($data2);	
		return true;
	}
	// Function to update record in table
	public function update_original_signature_tasks($data2, $id){
		
		$db      = \Config\Database::connect();
		$builder = $db->table('ci_signature_documents');
	...
	// Function to update record in table
	public function update_chat_status($data, $from_id,$session_id){
		
		$db      = \Config\Database::connect();
		$builder = $db->table('ci_chat_messages');
		$builder->where('from_id', $from_id);
		$builder->where('to_id', $session_id);
		$builder->update($data);
		return true;
	}
	// Function to update record in table
	public function update_notification_settings($data, $module_options,$company_id){
		
		$db      = \Config\Database::connect();
		$builder = $db->table('ci_erp_notifications');
		$builder->where('module_options', $module_options);
		$builder->where('company_id', $company_id);
		$builder->update($data);
		return true;
	}
	// Function to update record in table
	public function update_submited_form_record($data2, $id){
		
		$db      = \Config\Database::connect();
		$builder = $db->table('ci_form_completed_fields');
	...
	// Function to delete record in table
	public function delete_form_options($id){
	...
	// Function to delete record in table
	public function delete_form_completed_options($id){
	...
	// Function to delete record in table
	public function delete_send_form_options($id){
		
		$db      = \Config\Database::connect();
		$builder = $db->table('ci_form_send');
		$builder->where('form_id', $id);
		$builder->delete();	
	}
