...
class Paypal extends BaseConfig {
   ...
   public function __construct() {
	  ...
	  if($xin_super_system['paypal_sandbox']=="yes"){
      ...
      $this->paypal_url = $paypal_url;//($sanbox == FALSE)?'https://www.sandbox.paypal.com/cgi-bin/webscr':'https://www.paypal.com/cgi-bin/webscr';
      $this->last_error = '';
