...
class Membership extends BaseController {
	...
	public function membership_list()
     {
        ...
        foreach($membership as $r) {						
			...
			$sales = $CompanymembershipModel->where('membership_id', $r['membership_id'])->countAllResults();
			...
			$cname = '<div class="d-inline-block align-middle">
				<img src="'.base_url('/public/assets/images/pages').'/'.$r['plan_icon'].'" alt="" class="img-radius align-top m-r-15" style="width:40px;">
				<div class="d-inline-block">
					<h6 class="m-b-0">'.$plan2.'</h6>
					<p class="m-b-0">'.$r['subscription_id'].'</p>
				</div>
			</div>';
			...
			$_sales = '<span class="badge badge-pill badge-primary">'.$sales.' '.$suser.'</span>';
			$links = '
				'.$_sales.'
	...
	public function add_membership() {
		...
		$plan_icon = $this->request->getPost('plan_icon',FILTER_SANITIZE_STRING);
