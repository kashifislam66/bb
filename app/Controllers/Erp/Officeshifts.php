	...
	public function office_shifts_list() {
		...
		$data = array();
          ...
          foreach($get_data as $r) {
			...
			if($r['monday_lunch_break'] == ''){
				$monday = $monday;
			} else {
				$monday = $monday.'<br><span class="badge badge-light-success">'.lang('Main.xin_lunch_break').' '.$r['monday_lunch_break'].'</span>';
			}
			if($r['tuesday_lunch_break'] == ''){
				$tuesday = $tuesday;
			} else {
				$tuesday = $tuesday.'<br><span class="badge badge-light-success">'.lang('Main.xin_lunch_break').' '.$r['tuesday_lunch_break'].'</span>';
			}
			if($r['wednesday_lunch_break'] == ''){
				$wednesday = $wednesday;
			} else {
				$wednesday = $wednesday.'<br><span class="badge badge-light-success">'.lang('Main.xin_lunch_break').' '.$r['wednesday_lunch_break'].'</span>';
			}
			if($r['thursday_lunch_break'] == ''){
				$thursday = $thursday;
			} else {
				$thursday = $thursday.'<br><span class="badge badge-light-success">'.lang('Main.xin_lunch_break').' '.$r['thursday_lunch_break'].'</span>';
			}
			if($r['friday_lunch_break'] == ''){
				$friday = $friday;
			} else {
				$friday = $friday.'<br><span class="badge badge-light-success">'.lang('Main.xin_lunch_break').' '.$r['friday_lunch_break'].'</span>';
			}
			if($r['saturday_lunch_break'] == ''){
				$saturday = $saturday;
			} else {
				$saturday = $saturday.'<br><span class="badge badge-light-success">'.lang('Main.xin_lunch_break').' '.$r['saturday_lunch_break'].'</span>';
			}
			if($r['sunday_lunch_break'] == ''){
				$sunday = $sunday;
			} else {
				$sunday = $sunday.'<br><span class="badge badge-light-success">'.lang('Main.xin_lunch_break').' '.$r['sunday_lunch_break'].'</span>';
			}
			$data[] = array(
				$ishift_name,
				$monday,
	...
	public function add_office_shift() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			if(!$this->validate($rules)){
				...
				$monday_lunch_break = $this->request->getPost('monday_lunch_break',FILTER_SANITIZE_STRING);
				$tuesday_lunch_break = $this->request->getPost('tuesday_lunch_break',FILTER_SANITIZE_STRING);
				$wednesday_lunch_break = $this->request->getPost('wednesday_lunch_break',FILTER_SANITIZE_STRING);
				$thursday_lunch_break = $this->request->getPost('thursday_lunch_break',FILTER_SANITIZE_STRING);
				$friday_lunch_break = $this->request->getPost('friday_lunch_break',FILTER_SANITIZE_STRING);
				$saturday_lunch_break = $this->request->getPost('saturday_lunch_break',FILTER_SANITIZE_STRING);
				$sunday_lunch_break = $this->request->getPost('sunday_lunch_break',FILTER_SANITIZE_STRING);
				//
				$monday_lunch_break_out = $this->request->getPost('monday_lunch_break_out',FILTER_SANITIZE_STRING);
				$tuesday_lunch_break_out = $this->request->getPost('tuesday_lunch_break_out',FILTER_SANITIZE_STRING);
				$wednesday_lunch_break_out = $this->request->getPost('wednesday_lunch_break_out',FILTER_SANITIZE_STRING);
				$thursday_lunch_break_out = $this->request->getPost('thursday_lunch_break_out',FILTER_SANITIZE_STRING);
				$friday_lunch_break_out = $this->request->getPost('friday_lunch_break_out',FILTER_SANITIZE_STRING);
				$saturday_lunch_break_out = $this->request->getPost('saturday_lunch_break_out',FILTER_SANITIZE_STRING);
				$sunday_lunch_break_out = $this->request->getPost('sunday_lunch_break_out',FILTER_SANITIZE_STRING);
				...
				$data = [
					...
					'monday_lunch_break'  => $monday_lunch_break,
					'tuesday_lunch_break'  => $tuesday_lunch_break,
					'wednesday_lunch_break'  => $wednesday_lunch_break,
					'thursday_lunch_break'  => $thursday_lunch_break,
					'friday_lunch_break'  => $friday_lunch_break,
					'saturday_lunch_break'  => $saturday_lunch_break,
					'sunday_lunch_break'  => $sunday_lunch_break,
					'monday_lunch_break_out'  => $monday_lunch_break_out,
					'tuesday_lunch_break_out'  => $tuesday_lunch_break_out,
					'wednesday_lunch_break_out'  => $wednesday_lunch_break_out,
					'thursday_lunch_break_out'  => $thursday_lunch_break_out,
					'friday_lunch_break_out'  => $friday_lunch_break_out,
					'saturday_lunch_break_out'  => $saturday_lunch_break_out,
					'sunday_lunch_break_out'  => $sunday_lunch_break_out,
