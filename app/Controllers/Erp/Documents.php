	...
	public function add_document() {
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			$rules = [
				...
				'document_file' => [
					'rules'  => 'uploaded[document_file]|ext_in[document_file,jpg,jpeg,png,pdf,doc,docx]|max_size[document_file,10240]',
					'errors' => [
		...
		if ($this->request->getPost('type') === 'add_record') {
			...
			$rules = [
				'license_name' => [
					'rules'  => 'required',
					'errors' => [
						'required' => lang('Main.xin_employee_name_required_error')
					]
				],
				'document_type' => [
					'rules'  => 'required',
				...
				'license_number' => [
					'rules'  => 'required',
					'errors' => [
						'required' => lang('Main.xin_document_number_required_error')
					]
				],
				'document_file' => [
					'rules'  => 'uploaded[document_file]|ext_in[document_file,jpg,jpeg,png,pdf,doc,docx]|max_size[document_file,10240]',
